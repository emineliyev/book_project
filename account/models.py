...
class MyUser(AbstractBaseUser):
    ...
    institution_name = models.CharField(max_length=60, verbose_name='Müəssisə adı')
    photo = models.ImageField(upload_to="image/%Y/%m/%d/", verbose_name='Şəkil', blank=True, null=True)
